...
export default function CreatePage() {
  ...
  return (
    <div className="max-w-lg mx-auto p-8 bg-white shadow-md rounded-lg mt-10">
      <h1 className="text-3xl font-semibold text-center mb-6">Upload up to 3 Images</h1>

      {/* Input fields for Story ID and Page ID */}
      <div className="mb-4">
        <label className="block text-gray-700 text-sm font-bold mb-2">Story ID</label>
        <input
          type="text"
          value={storyID}
      ...
      <div className="mb-4">
        <label className="block text-gray-700 text-sm font-bold mb-2">Select Images (Max 3)</label>
        <input
          type="file"
          accept="image/*"
          multiple
      ...
      <div className="mb-4">
        <h2 className="text-gray-700 text-lg font-semibold mb-2">Selected Images</h2>
        {images.map((img, index) => (
          <div key={index} className="flex items-center mb-2">
            ...
            <button
              ...
              disabled={index === 0}
              className="bg-gray-200 px-2 py-1 text-xs rounded-full mr-2"
            >
              Move Up
            </button>
            <button
      ...
      <div className="text-center">
        <button
          ...
          className={`px-6 py-2 text-white rounded-full font-semibold focus:outline-none focus:ring ${
